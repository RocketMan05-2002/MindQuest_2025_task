...
(async function () {
  ...
  const renderEmployees = () => {
    ...
    employees.forEach((emp) => {
      ...
      employee.innerHTML = `${emp.shop_name} <i class="deleteEmployee">❌</i>`;
  ...
  const renderSingleEmployee = () => {
    ...
    employeeInfo.innerHTML = `
        ...
        ${selectedEmployee.shop_name} ${selectedEmployee.shopkeeper_name}
        </span>
        <span>${selectedEmployee.address}</span>

        <span> Rating - ${selectedEmployee.rating}</span>
        <span> Reviews - ${selectedEmployee.reviews}</span>
        `;
  };
